...
henceforth be referred to simply as ``the Challenge.''  It was originally
intended to be held at the International Conference on Robotics and Automation
({ICRA}) in May 2015. However, The date and location remain to be decided.  The purpose
...
out on a cart that is brought to it and sort them into bins. Carts arrive after
