...
\section{Challenge problem settings}
...
\subsection{Scaling double-integrators}\label{sec:scalingdoubleinteg}
...
\subsubsection{Dynamics and constraints}
...
\subsubsection{Implementation plan for the challenge}
...
\subsection{Traffic network of Dubins cars}\label{sec:trafficdubins}
...
\subsection{Dexterous manipulation on the assembly line}\label{sec:dexterousmanip}
