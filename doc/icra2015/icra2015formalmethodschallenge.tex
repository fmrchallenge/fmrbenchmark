...
\date{24 Sep 2014}
\begin{abstract}
This is the normative reference for the first challenge on formal methods for robotics.
...
We briefly present basic concepts and notation
that may not be widely known by potential participants at ICRA.  Linear
...
\subsection{Dynamics and constraints}
All cars including the controlled robot are assumed to have the same rigid body shape and to have
