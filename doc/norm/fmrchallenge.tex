...
\item violation of task formula is worse than not trying to answer the problem instance.
\item rate if increase in synthesis time for increasing number of integrators and
increasing number of state dimensions
\end{enumerate}
...
\begin{enumerate}
\item time to begin, i.e., duration between being first given the problem instance description and requesting start of the play.
\item number of collisions
\item goals visited as a ratio of all goals
\item time spent outside of correct lane as a ratio of total time
\item time spent outside of road network as a ratio of total time
\item all of the above with varying numbers of e-agents and size of the road net
\end{enumerate}
